...
contract TezoroLendingAgentFactory is Ownable {
    ...
    uint256 public YEARLY_FEE_BPS = 90; // 0.9%
    ...
    function createAgent(
        ...
        TezoroLendingAgent(agent).initialize(
            msg.sender,
            lensAddress,
            adapters,
            address(this)
    ...
    function _setFeeRateBps(uint256 newFeeRateBps) internal {
        if (newFeeRateBps > 100) revert FeeRateTooHigh(); // Max 1% fee
        YEARLY_FEE_BPS = newFeeRateBps;
    }
